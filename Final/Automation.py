...
# CSV file
Calculate_csv = "white_ratio_test.csv"
Name_Glare = "test.csv"
Final = "glare_ture_pred_test.csv"
...
with open(Calculate_csv, "w", newline="") as file:
...
with open(Name_Glare, "r") as existing_file:
    reader = csv.reader(existing_file)
    existing_data = list(reader)

# Open the new CSV file in read mode
with open(Calculate_csv, "r") as new_file:
...
with open(Final, "w", newline="") as merged_file:
